...
public class RestControllerExceptionHandler {
  ...
  private ResponseEntity<CustomErrorResponse> buildResponse(HttpServletRequest request,
      HttpStatus status,
      String message) {
...
//  public ResponseEntity<CustomErrorResponse> handleIllegalOrNull(Exception e,
//      HttpServletRequest request) {
//    log.warn("Illegal or null exception: {}", e.getMessage(), e);
//    return buildResponse(request, HttpStatus.BAD_REQUEST,
//        "요청 처리 중 문제가 발생했습니다. error: " + e.getMessage());
//  }
//
//  @ExceptionHandler(HttpRequestMethodNotSupportedException.class)
//  public ResponseEntity<CustomErrorResponse> handleMethodNotAllowed(
...
//        "데이터 무결성 오류가 발생했습니다. (중복 또는 제약 조건 위반): " + e.getMessage());
//  }
//
...
//  public ResponseEntity<CustomErrorResponse> handleDataAccess(DataAccessException e,
//      HttpServletRequest request) {
...
//  }
  ...
  public ResponseEntity<CustomErrorResponse> handleDataAccess(CafeNotFoundException e,
      HttpServletRequest request) {
    log.error("Data access error: {}", e.getMessage(), e);
    return buildResponse(request, HttpStatus.INTERNAL_SERVER_ERROR,
        "카페 조회가 실패하였습니다");
  ...
  @ExceptionHandler(InvalidCafeIdException.class)
  public ResponseEntity<CustomErrorResponse> handleDataAccess(InvalidCafeIdException e,
      HttpServletRequest request) {
    log.error("Data access error: {}", e.getMessage(), e);
    return buildResponse(request, HttpStatus.BAD_REQUEST,
        "유효하지 않은 cafeId입니다");
